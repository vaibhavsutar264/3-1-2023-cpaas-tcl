...
import { ChangePageBilling, filterData, loadInvoices, searchData, sortData } from '../../redux/slices/billingSlice'
...
export const Billing = ({ toggleTheme }: { toggleTheme: any }) => {
  ...
  const { t } = useLocales()
  const cards = [
    { titel: t('allInvoice'), value: getCardCount(MasterData, 'Payment_Status', ''), icon: <Invoice />, bgcolor: "white", textColor: "#1A73E8", cntColor: '#344857' },
    { titel: t('overdue'), value: getCardCount(MasterData, 'Payment_Status', 'overdue'), icon: <Overdue />, bgcolor: "#363f5e", textColor: "white", cntColor: 'white' },
    { titel: t('unpaidInvoices'), value: getCardCount(MasterData, 'Payment_Status', 'pending'), icon: <UnpaidInvoice />, bgcolor: "#e54457", textColor: "white", cntColor: 'white' },
    { titel: t('paidInvoices'), value: getCardCount(MasterData, 'Payment_Status', 'completed'), icon: <PaidInvoice />, bgcolor: "#3DB887", textColor: "white", cntColor: 'white' },
  ]
